...
@register.parser
class Nuts3Parser(VocabularyParser):
    ...
    def vocabulary(self) -> Vocabulary:
        ...
        Returns:
            Vocabulary data
        """
        return Vocabulary.create(name='NUTS3 vocabulary',
                                 description='NUTS3 values for dataset regional coverage',
                                 url='http://nuts.geovocab.org/id/nuts3.html',
                                 topic='NUTS3')
    ...
    def load(self) -> any:
        ...
        """
        path = Path(__file__).parent / "nuts3.xml"
