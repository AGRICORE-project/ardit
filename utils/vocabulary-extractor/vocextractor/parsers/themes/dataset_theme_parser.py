...
@register.parser
class DataThemeParserHTML(VocabularyParser):
    ...
    def vocabulary(self) -> Vocabulary:
        ...
        Returns:
            Vocabulary data
        """
        return Vocabulary.create(name='Dataset theme vocabulary',
                                 description='Data Theme Authority tables for dataset themes',
