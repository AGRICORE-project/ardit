...
@register.parser
class Nuts2Parser(VocabularyParser):
    ...
    def vocabulary(self) -> Vocabulary:
        ...
        Returns:
            Vocabulary data
        """
        return Vocabulary.create(name='NUTS2 vocabulary',
                                 description='NUTS2 values for dataset regional coverage',
                                 url='http://nuts.geovocab.org/id/nuts2.html',
                                 topic='NUTS2')
    ...
    def load(self) -> any:
        ...
        """
        path = Path(__file__).parent / "nuts2.xml"
