...
@register.parser
class ResourceTypeParser(VocabularyParser):

    def __init__(self):
        super().__init__()

    def vocabulary(self) -> Vocabulary:
        return Vocabulary.create(name='DCMI resource type vocabulary',
                                 description='Vocabulary to describe the genre or nature of a resource',
                                 url='https://dublincore.org/specifications/dublin-core/dcmi-terms/#section-7',
                                 topic='RESOURCE_TYPE')
