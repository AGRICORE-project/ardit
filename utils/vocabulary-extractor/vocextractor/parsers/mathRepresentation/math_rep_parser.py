...
@register.parser
class MathRepresentationParser(VocabularyParser):

    def __init__(self):
        super().__init__()

    def vocabulary(self) -> Vocabulary:
        return Vocabulary.create(name='Math representation vocabulary',
                                 description='Math representation values for data frequency',
                                 url='',
                                 topic='MATH_REPRESENTATION')
