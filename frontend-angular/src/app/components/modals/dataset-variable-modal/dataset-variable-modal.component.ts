...
@Component({
  selector: 'app-dataset-variable-modal',
  templateUrl: './dataset-variable-modal.component.html',
  styleUrls: ['./dataset-variable-modal.component.css']
})
export class DatasetVariableModalComponent implements OnInit {
  ...
  @Input() variableType: string; // Dataset variable type [GEOREFERENCED, SOCIOECONOMIC, PRICE]
  ...
  */
   ...
   */
   public submitDatasetVariable(): void {
    ...
    datasetVariable.variableType = this.variableType; // Mark the dataset variable type
